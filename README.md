...
This repo is the companion project for a three part blog series on CI/CD with GitHub Actions. It is a small, dependency light TypeScript project whose only real purpose is to give the workflows something real to lint, test, build, and deploy.
